...
for i in range(4,6): 
    ds = xr.open_zarr(cat['LOCA2.UCSD.'+ 'HadGEM3-GC31-LL'+'.historical.day.d03'].df.path[i],storage_options={'anon': True})
    ds.to_netcdf('HadGEM3-GC31-LL'+'_historical_r1i1p1f1_'+str(var_list[i])+'.nc')